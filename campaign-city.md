---
title: New York City Campaign | Ban the Scan
layout: default
nav: city
description: NYC Council bills would ban biometric surveillance in public accommodations,
  residential buildings, and by city government. See the bills and sign the petition.
hero:
  eyebrow: New York City Campaign
  heading: Three bills. One city ban.
  sub: Three bills at the New York City Council would ban biometric surveillance in
    public accommodations, residential buildings, and by city government itself. Here's
    what each bill does, and how to tell your Council Member to pass them.
bills_section:
  label: The Legislation
  heading: What these three bills actually do.
  intro: Two of the three bills have already been introduced at the City Council.
    The third, a ban on city government's own use of biometric surveillance, is still
    being drafted, which is exactly why it needs public pressure now.
map:
  label: Track the Scan
  heading: See where biometric surveillance shows up in NYC.
...
contact:
  label: Get Involved
  heading: Contact your City Council Member.
  intro: Signing the petition matters, but a direct call or email to your own Council
    Member carries the most weight at City Hall, especially on the bill that still
    needs a sponsor. Here's how in three steps.
  steps:
  - num: '01'
    title: Find Your Council Member
    text: Look up which Council Member represents your district. That's who you'll
      be calling or emailing.
    links:
    - label: Find My Council Member
  ...
  - num: '02'
    ...
    quote: "&ldquo;Hi, my name is ___ and I'm a constituent from [neighborhood/zip].
      I'm calling to ask Council Member [name] to co-sponsor and vote yes on Int 0213-2026
      and Int 0428-2026, and to introduce a bill banning city government's own use
...
bridge:
  ...
  intro: Four bills in the State Legislature would extend similar bans across all
    of New York. See the details and sign that petition too.
  cta_label: View the State Campaign
final_cta:
  label: Stay Involved
  heading: Don't miss a hearing date.
  intro: 'Get email updates as these bills move through the City Council: hearing
    dates, votes, and moments when your call matters most.'
...
<main id="main">
    ...
    <!-- BIOMETRIC MAP -->
    <section class="precedent" id="map">
        <div class="wrap">
            <p class="section-label">{{ page.map.label }}</p>
            <h2 class="section-heading">{{ page.map.heading }}</h2>
            <p class="section-intro">{{ page.map.intro }}</p>
            ...
            <div class="petition-embed">
                <iframe
                    ...
                    frameborder="0"
                    scrolling="no"
                    title="Biometric Surveillance Map of New York City"
                ></iframe>
    ...
    <section class="petition" id="petition">
        <div class="wrap">
            ...
            <div class="petition-embed">
                <!--
                  NOTE: this Action Network petition's letter text currently
                  cites Intro 0217-2024 and Intro 0425-2024. Confirm these
                  have been updated to the current session's numbers
                  (Int 0213-2026 and Int 0428-2026) before publishing.
                -->
                <link
    ...
    <section class="contact-legislators" id="contact">
        <div class="wrap">
            ...
            <div class="org-callout">
                <p>{{ page.contact.map_callout_text }}</p>
    ...
    <section class="bridge-cta" id="bridge">
        <div class="wrap">
            ...
            <div class="bridge-actions">
                <a class="btn btn-yellow" href="{{ '/campaign-state.html' | relative_url }}"
